...
<div class="fieldcontain ${hasErrors(bean: dealInstance, field: 'originalPrice', 'error')} required">
	<label for="originalPrice">
		<g:message code="deal.originalPrice.label" default="Original Price" />
		<span class="required-indicator">*</span>
	</label>
	<g:field name="originalPrice" value="${fieldValue(bean: dealInstance, field: 'originalPrice')}" required=""/>
</div>

<div class="fieldcontain ${hasErrors(bean: dealInstance, field: 'currentPrice', 'error')} required">
	<label for="currentPrice">
		<g:message code="deal.currentPrice.label" default="Current Price" />
		<span class="required-indicator">*</span>
	</label>
	<g:field name="currentPrice" value="${fieldValue(bean: dealInstance, field: 'currentPrice')}" required=""/>
</div>
