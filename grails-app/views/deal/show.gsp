	...
	<body>
		...
		<div id="show-deal" class="content scaffold-show" role="main">
			...
			<ol class="property-list deal">
				...
				<g:if test="${dealInstance?.originalPrice}">
				<li class="fieldcontain">
					<span id="originalPrice-label" class="property-label"><g:message code="deal.originalPrice.label" default="Original Price" /></span>
					
						<span class="property-value" aria-labelledby="originalPrice-label"><g:fieldValue bean="${dealInstance}" field="originalPrice"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${dealInstance?.currentPrice}">
				<li class="fieldcontain">
					<span id="currentPrice-label" class="property-label"><g:message code="deal.currentPrice.label" default="Current Price" /></span>
					
						<span class="property-value" aria-labelledby="currentPrice-label"><g:fieldValue bean="${dealInstance}" field="currentPrice"/></span>
