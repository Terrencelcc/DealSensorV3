			...
			while(succeed==false){
				try{
					...
					try{
						...
						String text = "2013-"+(rand.nextInt(12)+1)+"-"+(rand.nextInt(30)+1)+"T00:00:00.000-0500";
						...
						def price=rand.nextInt(10)+10
						def discount=rand.nextInt(10)+1
						def dealInstance=new Deal(title: "Test Deal from "+name,description:"no description",expireDate:parsed,originalPrice:price,currentPrice:(price-discount))
